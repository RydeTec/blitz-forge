...
> may be of any number of dimensions. For example:
>
> > *Dim arr(10)*
>
...
> Arrays may be dimensioned inside functions, but a corresponding
> \'Dim\' statement of the same array must also appear somewhere in the
