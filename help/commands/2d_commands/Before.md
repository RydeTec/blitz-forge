...
# Description
  ...
  before continuing.\
  \
  Use this to assign a custom Type object to the previous object in the
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=Before&ref=comments){target="_blank"}
