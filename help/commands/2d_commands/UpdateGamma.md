...
# Description
  ...
  [SetGamma](../2d_commands/SetGamma.htm){.small} commands in order to
  effect actual changes.\
  \
  See also: [SetGamma](SetGamma.htm){.small}.

  -----------------------------------------------------------------------

# [Example](../2d_examples/UpdateGamma.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=UpdateGamma&ref=comments){target="_blank"}
