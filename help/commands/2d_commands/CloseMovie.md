...
# Description
  ...
  [OpenMovie](../2d_commands/OpenMovie.htm){.small} .\
  \
  See also: [OpenMovie](OpenMovie.htm){.small},
  [DrawMovie](DrawMovie.htm){.small},
...
# [Example](../2d_examples/CloseMovie.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=CloseMovie&ref=comments){target="_blank"}
