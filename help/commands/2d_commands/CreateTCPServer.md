...
# Description
  ...
  -----------------------------------------------------------------------
  Creates a TCP/IP server with the designated port. Use this for
  communications between other clients and the local box. See
  OpenTCPStream, CloseTCPServer, and CloseTCPStream for more
  information.\
  \
...
# [Example](../2d_examples/CreateTCPServer.bb)

  -----------------------------------------------------------------------
  ; CreateTCPServer, CloseTCPServer, AcceptTCPStream Example\
  ; This code is in two parts, and needs to be run seperately on the same
  machine\
  \
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=CreateTCPServer&ref=comments){target="_blank"}
