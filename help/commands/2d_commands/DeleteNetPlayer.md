...
# Description
  ...
  -----------------------------------------------------------------------
  Using the playerID generated by the CreateNetPlayer command, this
  command will remove the designated player from the network game.\
  \
  This also causes a special message to be sent to all remote machines
  (see NetMsgType).

  -----------------------------------------------------------------------

# [Example](../2d_examples/DeleteNetPlayer.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=DeleteNetPlayer&ref=comments){target="_blank"}
