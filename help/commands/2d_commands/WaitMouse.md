...
# Description
  ...
  use a WHILE \... WEND awaiting a MouseHit value - refreshing your
  screen each loop.

  -----------------------------------------------------------------------

# [Example](../2d_examples/WaitMouse.bb)
  ...
  button=WaitMouse()\
  \
  Print \"The mouse button code of the button you pressed was: \" +
  button\
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=WaitMouse&ref=comments){target="_blank"}
