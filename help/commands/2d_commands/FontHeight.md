...
# [Example](../2d_examples/FontHeight.bb)
  ...
  SetFont fntArial\
  Text 400,0,\"The font width of the widest character is:\"+
  FontWidth(),True,False\
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=FontHeight&ref=comments){target="_blank"}
