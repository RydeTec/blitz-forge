...
# Description
  ...
  command performs pixel perfect accurate collision detection between the
  ...
  container to show you how accurate this command really is. The
  ImageRectOverlap example is identical to this one - and shows how
  inaccurate the overlapping method can be with graphics of this nature.

  -----------------------------------------------------------------------

# [Example](../2d_examples/ImageRectCollide.bb)
  ...
  have pixel collided\
  Until ImageRectCollide
  (gfxCircle,circleX,circleY,0,hotX,hotY,hotW,hotH)\
  \
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=ImageRectCollide&ref=comments){target="_blank"}
