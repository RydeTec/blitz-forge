...
# Description
  ...
  image handle. This command returns the X coordinate. Use ImageYHandle
  to get the Y coordinate. Please see MidHandle for more information on
...
# [Example](../2d_examples/ImageXHandle.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=ImageXHandle&ref=comments){target="_blank"}
