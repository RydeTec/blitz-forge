...
# [Example](../2d_examples/CreateImage.bb)
  ...
  Graphics 640,480,16\
  \
  ; Create a blank image that is 32 pixels wide and 32 high with 10
  frames of 32x32\
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=CreateImage&ref=comments){target="_blank"}
