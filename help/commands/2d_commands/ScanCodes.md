...
\
  ...
  ---------------------------------------------------------------------------------------------------------------------------------------------------------
  This isn\'t a command at all, but rather a complete listing of key scancodes for use with the [KeyHit](KeyHit.htm) and [KeyDown](KeyDown.htm) commands.
  ---------------------------------------------------------------------------------------------------------------------------------------------------------
...
|    Right Bracket (\])        27                                       |
|       Retu                                                            |
| rn/Enter           28                   Return/Enter on Main Keyboard |
|       Left Control           29                                       |
|            A                 30                                       |
|            S                 31                                       |
|            D                 32                                       |
...
|         ABNT_C                                                        |
| 1             115               /? on Portugese (Brazilian) keyboards |
|                                                                       |
...
|         ABNT_C2                                                       |
|            126            Numpad . on Portugese (Brazilian) keyboards |
|          Eq                                                           |
| uals             141                   = on numeric keypad (NEC PC98) |
|        PrevTrack                                                      |
|       144        Previous Track (DIK_CIRCUMFLEX on Japanese keyboard) |
|                                                                       |
|           AT               145                             (NEC PC98) |
|                                                                       |
|       Colon (:)            146                             (NEC PC98) |
...
|        Com                                                            |
| ma (,)            179                    On Numeric Keypad (NEX PC98) |
|                                                                       |
...
|      Pa                                                               |
| ge Up/Prior          201                      Page Up on Arrow Keypad |
|                                                                       |
