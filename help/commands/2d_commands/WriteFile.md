...
# [Example](../2d_examples/WriteFile.bb)

  -----------------------------------------------------------------------
  ; Reading and writing custom types to files using ReadFile, WriteFile
  and CloseFile\
  \
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=WriteFile&ref=comments){target="_blank"}
