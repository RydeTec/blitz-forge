...
# Description
  ...
  HandleImage command. You can retrieve an image\'s handle using the
  ImageXHandle and ImageYHandle. Finally, you can make all images
...
# [Example](../2d_examples/MidHandle.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=MidHandle&ref=comments){target="_blank"}
