...
# Description
  ...
  nested conditionals, you should consider a SELECT/CASE structure. See
  the example.\
  \
  See also: [ElseIf](ElseIf.htm){.small}.

  -----------------------------------------------------------------------

# [Example](../2d_examples/Else){if.bb=""}
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=Else){if&ref="comments"
