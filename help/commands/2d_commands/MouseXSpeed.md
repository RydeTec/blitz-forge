...
# Description
  ...
  where it is NOW. You can use this command and MouseXSpeed() in pairs to
  ...
  \
  See also: [MouseYSpeed](MouseYSpeed.htm){.small}.

  -----------------------------------------------------------------------

# [Example](../2d_examples/MouseXSpeed.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=MouseXSpeed&ref=comments){target="_blank"}
