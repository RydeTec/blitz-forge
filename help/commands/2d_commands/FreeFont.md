...
# Description
  ...
  -----------------------------------------------------------------------
  This removes a TrueType font previously loaded into memory (though the
  LoadFont command).\
  \
...
# [Example](../2d_examples/FreeFont.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=FreeFont&ref=comments){target="_blank"}
