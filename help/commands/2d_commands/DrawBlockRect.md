...
# Description
  ...
  the original image will be ignored and drawn with the image.\
  \
  ...
  onto the playfield. If you want to draw the image portion with
  transparency or masking, use DrawImageRect instead.

  -----------------------------------------------------------------------

# [Example](../2d_examples/DrawBlockRect.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=DrawBlockRect&ref=comments){target="_blank"}
