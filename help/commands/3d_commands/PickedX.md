...
# Description
  ...
  \
  The coordinate represents the exact point of where something was
  picked.\
  \
...
# [Example](../3d_examples/PickedX.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=PickedX&ref=comments){target="_blank"}
