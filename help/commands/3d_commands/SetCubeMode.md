...
# Description
  ...
  [SetCubeFace](SetCubeFace.htm){.small}.

  -----------------------------------------------------------------------

# [Example](../3d_examples/SetCubeMode.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=SetCubeMode&ref=comments){target="_blank"}
