...
# Parameters
  ...
  y_radius# (optional) - y radius of entity\'s collision ellipsoid. If
  omitted the x_radius# will be used for the y_radius#.
...
# [Example](../3d_examples/EntityRadius.bb)
  ...
  EntityType cone,type_cone\
  \
  ; Enable collisions between type_sphere and type_cone, with
  ellipsoid-\>polygon method and slide response\
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=EntityRadius&ref=comments){target="_blank"}
