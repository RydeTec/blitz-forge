...
# [Example](../3d_examples/CameraZoom.bb)
  ...
  Text 0,40,\"There is a camel on the horizon, inbetween the cacti. Zoom
  in to see it.\"\
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=CameraZoom&ref=comments){target="_blank"}
