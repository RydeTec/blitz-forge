...
# [Example](../3d_examples/CameraFogColor.bb)
  ...
  Text 0,20,\"Press keys 1-6 to change CameraFogColor red#,green#,blue#
  values\
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=CameraFogColor&ref=comments){target="_blank"}
