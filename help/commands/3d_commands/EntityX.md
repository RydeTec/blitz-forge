...
# Parameters
  ...
  global = True for Global coordinates, False for Local. Optional,
  defaults to False.
...
# Description
  ...
  \
  Global coordinates refer to the 3d world. Blitz 3D uses a left-handed
  system:\
  \
  X+ is to the right\
  Y+ is up\
...
# [Example](../3d_examples/EntityX.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=EntityX&ref=comments){target="_blank"}
