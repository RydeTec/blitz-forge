...
# Description
  ...
  used to represent the terrain. A typical value is 2000.\
  \
...
# [Example](../3d_examples/TerrainDetail.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=TerrainDetail&ref=comments){target="_blank"}
