...
# [Example](../3d_examples/CameraClsMode.bb)
  ...
  \
  ; Use red ink color so we can see text on top of black or light blue
  background\
  Color 255,0,0\
  \
  While Not KeyDown(1)\
  ...
  \
  ; Draw a 2D background. When cls_color is set to 0, the 2D graphics
  will show behind the 3D graphics.\
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=CameraClsMode&ref=comments){target="_blank"}
