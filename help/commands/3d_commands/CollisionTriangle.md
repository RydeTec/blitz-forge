...
# Description
  ...
  \
  Index should be in the range 1\...CountCollisions( entity ),
  inclusive.\
  \
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=CollisionTriangle&ref=comments){target="_blank"}
