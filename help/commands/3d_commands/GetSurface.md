...
# Description
  ...
  \
  See also: [CountSurfaces](CountSurfaces.htm){.small},
  [FindSurface](FindSurface.htm){.small}.
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=GetSurface&ref=comments){target="_blank"}
