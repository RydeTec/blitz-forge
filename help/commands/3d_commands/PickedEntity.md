...
# Description
  ...
  -----------------------------------------------------------------------
  Returns the entity \'picked\' by the most recently executed Pick
  command. This might have been CameraPick, EntityPick or LinePick.\
  \
  Returns 0 if no entity was picked.

  -----------------------------------------------------------------------

# [Example](../3d_examples/PickedEntity.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=PickedEntity&ref=comments){target="_blank"}
