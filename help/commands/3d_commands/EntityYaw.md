...
# Parameters
  ...
  global (optional) - true if the yaw angle returned should be relative
  to 0 rather than a parent entity\'s yaw angle. False by default.
...
# [Example](../3d_examples/EntityYaw.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=EntityYaw&ref=comments){target="_blank"}
