...
# Description
  ...
  value returned is in the range 0 to 1.\
  \
  See also: TerrainY.

  -----------------------------------------------------------------------

# [Example](../3d_examples/TerrainHeight.bb)
...
\
Click
[here](http://www.blitzbasic.co.nz/b3ddocs/command.php?name=TerrainHeight&ref=comments){target="_blank"}
